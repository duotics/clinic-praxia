...
class Cirugia
{
    ...
    protected $mainTable = "db_cirugias";
    protected $mediaTable = "db_cirugias_media";
    protected $mainID = "id_cir";
    ...
    function getAllCirCon($idCon, $idPac)
    {
    ...
    function getAllMedia()
    {
        ...
        WHERE md5(id_cir)='{$this->id}' 
        AND db_media.estado=1
        ORDER BY id DESC";
        $res = $this->db->selectAllSQL($sql);
        return $res;
    }
    function insertCir(int $idp, $idc, $date, $diag, $desCir, $dateR, $desProt, $desEvo)
    {
    ...
    function updateCir(string $idr, $diag, $desCir, $dateR, $desProt, $desEvo)
    {
