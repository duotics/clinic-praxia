...
//detRowGSel($table,$fieldID,$fieldVal,$field,$param,$ord=FALSE,$valOrd=NULL,$ascdes='ASC')
$qryLC = sprintf(
...
$btnPrint = '<input type="button" value="click" onclick="imprSelec(' . "'repPrint'" . ')"> ';
$btnPrint = '<a class="printerButton btn btn-default btn-xs" data-id="' . $id . '" data-rel="' . $RAIZc . 'com_reportes/hcpD_print.php">
<i class="fa fa-print fa-lg"></i> Imprimir</a>';
?>
<?php echo genHeader($dM, 'page-header', null, $btnPrint) ?>
...
<div id="repPrint">
    <table class='table'>
        ...
        <tr>
            ...
            <td>Sexo</td>
            <td><?php echo $dPac_sexo['typ_val'] ?></td>
        </tr>
    </table>
    <?php if ($tRSlc > 0) { ?>
        <table class="table table-striped table-bordered">
            ...
            <?php do { ?>
                ...
                ?>
                <tr>
                    <th><?php echo $dRSlc['con_fec'] ?></th>
                    <th><?php echo $dCon_tipcon['typ_val'] ?></th>
                    <th><?php echo $dRSlc['dcon_mot'] ?></th>
                </tr>
                <tr>
                    <td colspan="3">
                        <div class="container">
                            ...
                            <table class="table">
                                ...
                                <?php if ($tRSld > 0) { ?>
                                    <tr>
                                        <th width="20%"><span class="label label-default">Diagnosticos</span></th>
                                        <td width="80%">
                                            <?php echo $resDiag ?>
                                        </td>
                                    </tr>
                                ...
                                <?php if ($trRSt > 0) { ?>
                                    <tr>
                                        <th><span class="label label-default">Recetas</span></th>
                                        <td>
                                            <?php echo $resTrat ?>
                                        </td>
                                    </tr>
                                ...
                                <?php if ($trRSe > 0) { ?>
                                    <tr>
                                        <td width="20%"><span class="label label-default">Examenes k</span></td>
                                        <td width="80%">
                                            <?php echo $resExa ?>
                                        </td>
                                    </tr>
