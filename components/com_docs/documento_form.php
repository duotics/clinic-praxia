...
<div class="row">
  ...
  <ul class="dropdown-menu">
		<?php do{?>
        <li><a href="<?php echo route['c'] ?>com_docs/documento_form.php?idd=<?php echo $idd ?>&iddf=<?php echo $row_RSdf['id_df'] ?>&idp=<?php echo $idp ?>&idc=<?php echo $idc?>&action=NEW"><i class="icon-file"></i> <small>Cambiar a</small> <?php echo $row_RSdf['nombre'] ?></a></li>
