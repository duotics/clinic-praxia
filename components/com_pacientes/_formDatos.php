<div class="row">
	<div class="col-sm-6">
		...
		<div class="row mb-2">
			...
			<div class="col-md-8">
				<?php echo $db->genSelect($db->detRowGSel('db_types', 'typ_cod', 'typ_val', 'typ_ref', 'SECTOR'), 'pac_sect', $dPac['pac_sect'] ?? null, ' form-control input-sm setDB', 'data-id="' . $ids . '" data-rel="pac"', NULL, true, 0) ?>
			</div>
		</div>
		<div class="row mb-2">
	...
	<div class="col-sm-6">
		...
		<div class="row mb-3">
			...
			<div class="col-md-7">
				<?php echo $db->genSelect($db->detRowGSel('db_types', 'typ_cod', 'typ_val', 'typ_ref', 'TIPSAN'), 'pac_tipsanpar', $dPac['pac_tipsanpar'] ?? null, ' form-control input-sm setDB', "data-rel='pac' data-id='$ids'") ?>
			</div>
		</div>
		<hr>
		<div class="row mb-3">
