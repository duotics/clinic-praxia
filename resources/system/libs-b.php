...
<!-- GRITTER -->
<script type="text/javascript" src="<?php echo route['a'] ?>js/jquery.gritter.min.js"></script>
<!--FULL CALENDAR-->
<script src='<?php echo route['a'] ?>plugins/fullcalendar/lib/moment.min.js'></script>
<script src='<?php echo route['a'] ?>plugins/fullcalendar/fullcalendar.min.js'></script>
<script src='<?php echo route['a'] ?>plugins/fullcalendar/lang-all.js'></script>
<!--Chart.js-->
<script type="text/javascript" src="<?php echo route['a'] ?>plugins/chart.js-3.4.1/package/dist/chart.min.js"></script>
<!-- Datatables -->
