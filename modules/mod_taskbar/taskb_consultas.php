<nav class="navbar navbar-default navbar-fixed-bottom" role="navigation">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
    	<a href="<?php echo route['c'] ?>com_calendar/reserva_lista.php" class="btn btn-primary navbar-btn fancybox.iframe fancyreload">
        ...
        <a href="<?php echo route['c'] ?>com_consultas/consultas_list.php" class="btn btn-primary navbar-btn navbar-right">Total Consultas <span class="badge"><?php echo fnc_totCons();?></span></a>
	</div>
</nav>